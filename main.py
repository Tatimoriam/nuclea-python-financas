        ...
        if opcao == "1":
            while True:
                ...
                if opcao == "1":
                    ...
                    cli_server = ClienteServer(cli)
                    cli = cli_server.deletar_cliente()
                    ...
                    cli = cli_server.listar_clientes()
            ...
            while True:
                ...
                if opcao == "1":
                    ...
                    if idCli:
                        ...
                        ord_server = OrdemServer(ord)
                        ord_server.inserir_ordem()
                    ...
                    if idCli:
                        ...
                        if ord:
                            ...
                            print("Data da Compra:", ord.data_compra)
                            ...
                            ord_server.alterar_ordem(ticket)
                    ...
                    if cpf:
                        ord = Ordem()
                        ord_server = OrdemServer(ord)
                        ordens = ord_server.lista_ordem_cliente(cpf)

                        if ordens:
                            print("Ordens do Cliente de CPF", cpf)
                            for ordem in ordens:
                                print(ordem)
                        else:
